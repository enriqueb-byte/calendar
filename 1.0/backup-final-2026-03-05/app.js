...
function switchView(mode) {
  ...
  if (planner) planner.classList.toggle('view-block-planner-off', mode !== 'planner');
  if (audit) audit.classList.toggle('view-block-audit-visible', mode === 'audit');
  if (audit) audit.classList.toggle('view-block-audit-off', mode === 'life');
  if (life) life.classList.toggle('view-block-life-visible', mode === 'life');
